    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
      ...
      <div>
        <p>
          ...
          stand, but most people don't really want to share their compensation:
          <ul>
            <li>
        ...
        <p>
          ...
          It keeps your exact compensation private. Instead, each of you will
        ...
        <p>
          ...
          The size of the difference remains secret, which limits the social
          risk.
        </p>
        <p>
          The result is calculated in an entirely peer to peer way. No servers
          are involved in the cryptography or can otherwise see your
          compensation. Only your peer can see anything meaningful, and the only
          meaningful information they can get is the result, even if they use a
          modified app.
        </p>
        <p>
